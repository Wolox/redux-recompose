...
describe('completeReducer', () => {
  it('Throws if a reducer description is not present', () => {
    expect(() => completeReducer(null)).toThrow(new Error('Reducer description is incomplete, should contain at least a primaryActions field'));
  });
  it('Throws if a reducer description has not a primaryActions field', () => {
    expect(() => completeReducer({ a: 1 })).toThrow(new Error('Reducer description is incomplete, should contain at least a primaryActions field'));
  });
